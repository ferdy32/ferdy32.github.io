...
def cari_data(nip):
    data = {
        101: {'nama': 'Rifan Fadlan Ramadlan', 'jabatan': 'General Marketing', 'alamat': 'jln. Gobras No 12', 'jenis_kelamin': 'Laki-Laki', 'ttl': 'Tasikmalaya, 20 Juni 2003', 'gaji_pokok': 25000000, 'jumlah_produk_terjual': 32000},
        102: {'nama': 'Ferdi Nuraripin', 'jabatan': 'Regional Sales Manager', 'alamat': 'jln Cibangun no.127', 'jenis_kelamin': 'Laki-Laki', 'ttl': 'Tasikmalaya, 08 Mei 2003', 'gaji_pokok': 18000000, 'jumlah_produk_terjual': 26000},
        103: {'nama': 'Megale Oktana', 'jabatan': 'Sales Manager Marketing', 'alamat': 'jln Manonjaya', 'jenis_kelamin': 'Laki-Laki', 'ttl': 'Tasikmalaya, 02 Januari 2003', 'gaji_pokok': 10000000, 'jumlah_produk_terjual': 21000},
        104: {'nama': 'Hari Fitriana', 'jabatan': 'Supervisor', 'alamat': 'jln Mangkubumi', 'jenis_kelamin': 'Laki-Laki', 'ttl': 'Tasikmalaya, 08 Agustus 2002', 'gaji_pokok': 3500000, 'jumlah_produk_terjual': 34000},
        105: {'nama': 'M. Alif Kudsian Putra', 'jabatan': 'Sales Taking Order', 'alamat': 'Nagarawanagi', 'jenis_kelamin': 'Laki-Laki', 'ttl': 'Tasikmalaya, 21 September 2003', 'gaji_pokok': 2700000, 'jumlah_produk_terjual': 49000},
        106: {'nama': 'Salman Faturrohman', 'jabatan': 'Helper', 'alamat': 'Jakarta', 'jenis_kelamin': 'Laki-Laki', 'ttl': 'Tasikmalaya, 29 September 2003', 'gaji_pokok': 2200000, 'jumlah_produk_terjual': 180},
        107: {'nama': 'Gilang', 'jabatan': 'Driver', 'alamat': 'Pangandaran', 'jenis_kelamin': 'Laki-Laki', 'ttl': 'Tasikmalaya, 04 Desember 2002', 'gaji_pokok': 2200000, 'jumlah_produk_terjual': 1100},
    }
...
def main():
    ...
    tanggal = st.date_input("Masukkan tanggal:", format="DD/MM/YYYY")
    ...
    if st.button("CARI"):                                       
        with st.status("Downloading data...", expanded=True) as status:
            ...
            if hasil_pencarian:
                ...
                if jabatan in targets and hasil_pencarian.get('jumlah_produk_terjual', 0) >= targets[jabatan]:
                ...
                st.info(f"*Total Gaji pada Tanggal {tanggal} sebesar {format_rupiah(gaji_total + bonuses.get(jabatan, 0))}*")
                ...
                data_dict = {
                    ...
                    'Tunjangan Jabatan': [tunjangan['tunjangan_jabatan']],
                    'Tunjangan Makan': [tunjangan['tunjangan_makan']],
                    'Bonus': [bonus],
                    'Total Gaji': [gaji_total + bonuses.get(jabatan, 0)]
                }
                df = pd.DataFrame(data_dict)

                df.to_excel(f"output_gaji_{nip_dicari}_{tanggal}.xlsx", index=False)
